...
<p>FOOD_WAREHOUSE 테이블에서 // <code>FROM</code>
경기도에 위치한 // <code>WHERE</code> <strong>(LIKE, IN)</strong>
창고의 ID, 이름, 주소, 냉동시설 여부를 조회하는 SQL문// <code>SELECT</code>
이때 냉동시설 여부가 NULL인 경우,
'N'으로 출력시켜 주시고 // <code>NVL</code>
결과는 창고 ID를 기준으로 오름차순 정렬해주세요.// <code>ORDER BY</code></p>
<blockquote>
...
<blockquote>
<h3 id="null-관련-함수-정리-유선배-파랭이-p99">NULL 관련 함수 정리 (유선배 파랭이 p99)</h3>
</blockquote>
